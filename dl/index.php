...
<body>
    ...
    <header>
        <img src="polylogo.png" alt="Polytechnic Logo" id="logo">
    ...
    <div class="learning-resources">
        ...
        <div class="tabs-container">
            <a href="#" class="tab" target="_blank">NATIONAL DIGITAL LIBRARY</a>
            <a href="#" class="tab" target="_blank">NPTEL</a>
            <a href="#" class="tab" target="_blank">NPTEL MOOCs</a>
            <a href="#" class="tab" target="_blank">SWAYAM</a>
            <a href="#" class="tab" target="_blank">AICTE</a>
        </div>
    </div>
    ...
    <br><br><br><br><footer class="footer-section">
        <img src="polylogo.png" alt="Polytechnic Logo" id="logo"><br><br>
        <span>
